...
export class LobbyController {
    ...
    //     return this.lobby.createLobby(body.lobbyId);
    // }
    ...
    //     return this.lobby.joinLobby(id, body.lobbyId);
    // }
    ...
    //     return this.lobby.startSetup(id, body.lobbyId);
    // }

    // @Post(':id/leave')
    // async leave(@Param('id') id: string, @Body() body: LobbyDto) {
    //     return this.lobby.leaveLobby(id, body.lobbyId);
    // }
