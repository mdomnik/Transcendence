  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-6 text-[#64FFDA] flex items-center gap-2">
        ...
        {friends.length > 0 && (
          <span className="ml-auto text-sm font-normal text-[#8892B0]">({friends.length})</span>
        )}
      </h2>
      {friends.length === 0 ? (
          ...
          {friends.map((friendship) => (
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#64FFDA] to-[#38BDF8] flex items-center justify-center text-[#0A192F] font-bold text-lg">
